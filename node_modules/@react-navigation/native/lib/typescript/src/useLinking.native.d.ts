...
export default function useLinking(ref: React.RefObject<NavigationContainerRef<ParamListBase>>, { enabled, prefixes, config, getInitialURL, subscribe, getStateFromPath, getActionFromState, }: LinkingOptions<ParamListBase>): {
