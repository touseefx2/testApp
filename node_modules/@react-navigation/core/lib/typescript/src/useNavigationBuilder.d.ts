...
export default function useNavigationBuilder<State extends NavigationState, RouterOptions extends DefaultRouterOptions, ActionHelpers extends Record<string, () => void>, ScreenOptions extends {}, EventMap extends Record<string, any>>(createRouter: RouterFactory<State, any, RouterOptions>, options: DefaultNavigatorOptions<ParamListBase, State, ScreenOptions, EventMap> & RouterOptions): {
    ...
    navigation: {
        ...
        navigate<RouteName_3 extends string>(...args: [screen: RouteName_3] | [screen: RouteName_3, params: object | undefined]): void;
        navigate<RouteName_4 extends string>(options: {
            key: string;
            params?: object | undefined;
        } | {
            name: RouteName_4;
        ...
        isFocused(): boolean;
        canGoBack(): boolean;
        getParent<T_1 = import("./types").NavigationProp<ParamListBase, string, Readonly<{
            key: string;
            index: number;
            routeNames: string[];
            history?: unknown[] | undefined;
    ...
    descriptors: Record<string, import("./types").Descriptor<ScreenOptions, {
        ...
        navigate<RouteName_5 extends string>(...args: [screen: RouteName_5] | [screen: RouteName_5, params: object | undefined]): void;
        ...
        isFocused(): boolean;
        canGoBack(): boolean;
        getParent<T_2 = import("./types").NavigationProp<ParamListBase, string, Readonly<{
            key: string;
            index: number;
            routeNames: string[];
            history?: unknown[] | undefined;
