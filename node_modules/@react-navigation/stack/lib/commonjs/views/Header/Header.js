...
var _default = /*#__PURE__*/React.memo(function Header({
  ...
  const isFirstRouteInParent = (0, _native.useNavigationState)(state => state.routes[0].key === route.key);
  const statusBarHeight = options.headerStatusBarHeight !== undefined ? options.headerStatusBarHeight : isModal && !isFirstRouteInParent || isParentHeaderShown ? 0 : insets.top;
