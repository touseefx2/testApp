...
function forModalPresentationIOS({
  ...
  return {
    cardStyle: {
      ...
      borderBottomLeftRadius: (0, _reactNativeIphoneXHelper.isIphoneX)() ? borderRadius : 0,
      borderBottomRightRadius: (0, _reactNativeIphoneXHelper.isIphoneX)() ? borderRadius : 0,
